...
def k_cute(mOut: cute.Tensor, mDbg: cute.Tensor):
    ...
    # PERTURBATION: shift the operand base address into production's range.
    # Production's sQ starts at ~7360 u128 (117760 B); the unperturbed twin starts
    # at 192 u128 (3072 B). Everything else is unchanged.
    _pad = smem.allocate_tensor(
        element_type=Float16, layout=cute.make_layout(57344), byte_alignment=1024)
