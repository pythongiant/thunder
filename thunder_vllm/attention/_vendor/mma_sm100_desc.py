# Vendored from Dao-AILab/flash-attention (flash_attn/cute), Apache-2.0.
# Copyright (c) 2025 Tri Dao, Jay Shah, Ganesh Bikshandi, Ying Zhang,
# Vijay Thakkar, Pradeep Ramani.
# Upstream: https://github.com/Dao-AILab/flash-attention
# Vendored verbatim except for the module import path so the plugin stays
# self-contained (no flash-attn / quack runtime dependency for the tcgen05 path).
