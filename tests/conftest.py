...
def pytest_sessionstart(session):  # noqa: ARG001
    # One system fingerprint per test session so skips/failures can always be
    # attributed to a machine, torch build, and flag set.
    from thunder_vllm.utils.telemetry import system_line
